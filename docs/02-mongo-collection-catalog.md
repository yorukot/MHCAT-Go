...
| `chatgpt_get.js` | `chatgpt_get` | `chatgpt_gets` | `guild`, `price` | guild price/config | redeem credits; paid runtime transactionally debits | `{guild:1}` | numeric price type; duplicate guild rows fail closed | chatbot/economy config |
