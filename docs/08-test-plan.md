...
- High-priority parity fixtures:
  ...
  - join-role config/assignment, including exact UI/color/visibility, scalar reads, typed writes, usage, cached hierarchy, audience matrix, failure continuation, and account-age ordering; see [81-join-role.md](81-join-role.md)
