...
- Confirm whether an external ChatGPT worker still exists, that it preserves request `time`, and that it consumes the documented six-field handoff within ten seconds before enabling Go paid auto-chat.
