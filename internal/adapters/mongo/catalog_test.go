...
func TestPerformanceIndexesDoNotRequireDuplicateCleanup(t *testing.T) {
	...
	for _, test := range []struct {
		...
		{collection: "btns", index: "btns_guild_number_lookup"},
		...
		{collection: "guilds", index: "guilds_guild_lookup"},
		...
		{collection: "lotters", index: "lotters_guild_id_lookup"},
		{collection: "message_reactions", index: "message_reactions_guild_message_react_lookup"},
		{collection: "numbers", index: "numbers_guild_lookup"},
		{collection: "polls", index: "polls_guild_messageid_lookup"},
		{collection: "role_numbers", index: "role_numbers_guild_role_lookup"},
		{collection: "text_xps", index: "text_xps_guild_member_lookup"},
		{collection: "tickets", index: "tickets_guild_lookup"},
		{collection: "voice_xps", index: "voice_xps_guild_member_lookup"},
		{collection: "voice_xps", index: "voice_xps_guild_leavejoin"},
		{collection: "voice_channels", index: "voice_channels_guild_parent_lookup"},
		{collection: "work_sets", index: "work_sets_guild_lookup"},
		{collection: "work_somethings", index: "work_somethings_guild_name_lookup"},
		{collection: "work_users", index: "work_users_guild_user_lookup"},
