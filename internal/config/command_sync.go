...
const (
	...
	DefaultCommandSyncIncludeEconomyGame            = false
	...
	DefaultCommandSyncIncludeStatsRoleCount         = false
	...
	DefaultCommandSyncIncludeXPRank                 = false
...
func LoadCommandSyncRawWithLookup(lookup LookupFunc) (CommandSyncConfig, error) {
	cfg := CommandSyncConfig{
		...
		IncludeEconomyGame:            DefaultCommandSyncIncludeEconomyGame,
		...
		IncludeStatsRoleCount:         DefaultCommandSyncIncludeStatsRoleCount,
		...
		IncludeXPRank:                 DefaultCommandSyncIncludeXPRank,
	...
	if cfg.IncludeEconomyGame, err = getBool(lookup, "MHCAT_COMMAND_SYNC_INCLUDE_ECONOMY_GAME", DefaultCommandSyncIncludeEconomyGame); err != nil {
		return CommandSyncConfig{}, err
	}
	...
	if cfg.IncludeStatsRoleCount, err = getBool(lookup, "MHCAT_COMMAND_SYNC_INCLUDE_STATS_ROLE_COUNT", DefaultCommandSyncIncludeStatsRoleCount); err != nil {
		return CommandSyncConfig{}, err
	}
	...
	if cfg.IncludeXPRank, err = getBool(lookup, "MHCAT_COMMAND_SYNC_INCLUDE_XP_RANK", DefaultCommandSyncIncludeXPRank); err != nil {
		return CommandSyncConfig{}, err
	}
...
func ValidateCommandSync(cfg CommandSyncConfig) error {
	...
	if cfg.IncludeEconomyRPS {
		if !cfg.Staging.Mode {
			return fmt.Errorf("%w: MHCAT_COMMAND_SYNC_INCLUDE_ECONOMY_RPS requires MHCAT_STAGING_MODE=true", ErrInvalidCommandSyncConfig)
		}
		if cfg.Scope != CommandSyncScopeGuild {
	...
	if cfg.IncludeEconomyGame {
		if !cfg.Staging.Mode {
			return fmt.Errorf("%w: MHCAT_COMMAND_SYNC_INCLUDE_ECONOMY_GAME requires MHCAT_STAGING_MODE=true", ErrInvalidCommandSyncConfig)
		}
		if cfg.Scope != CommandSyncScopeGuild {
			return fmt.Errorf("%w: MHCAT_COMMAND_SYNC_INCLUDE_ECONOMY_GAME requires guild scope", ErrInvalidCommandSyncConfig)
		}
	}
	...
	if cfg.IncludeStatsRoleCount {
		if !cfg.Staging.Mode {
			return fmt.Errorf("%w: MHCAT_COMMAND_SYNC_INCLUDE_STATS_ROLE_COUNT requires MHCAT_STAGING_MODE=true", ErrInvalidCommandSyncConfig)
		}
		if cfg.Scope != CommandSyncScopeGuild {
			return fmt.Errorf("%w: MHCAT_COMMAND_SYNC_INCLUDE_STATS_ROLE_COUNT requires guild scope", ErrInvalidCommandSyncConfig)
		}
	}
	...
	if cfg.IncludeXPAdmin {
		if !cfg.Staging.Mode {
			return fmt.Errorf("%w: MHCAT_COMMAND_SYNC_INCLUDE_XP_ADMIN requires MHCAT_STAGING_MODE=true", ErrInvalidCommandSyncConfig)
		}
		if cfg.Scope != CommandSyncScopeGuild {
	...
	if cfg.IncludeXPRank {
		if !cfg.Staging.Mode {
			return fmt.Errorf("%w: MHCAT_COMMAND_SYNC_INCLUDE_XP_RANK requires MHCAT_STAGING_MODE=true", ErrInvalidCommandSyncConfig)
		}
		if cfg.Scope != CommandSyncScopeGuild {
			return fmt.Errorf("%w: MHCAT_COMMAND_SYNC_INCLUDE_XP_RANK requires guild scope", ErrInvalidCommandSyncConfig)
		}
	}
